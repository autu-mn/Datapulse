...
|------|-------|-------|------|------|----------|
| **GitPulse (微调后)** | **0.0712** | **0.1075** | **0.7699** | **73.00%** | **81.75%** |
| GRU+Text | 0.1084 | 0.1297 | 0.6496 | 68.28% | 79.12% |
| Transformer | 0.1693 | 0.1667 | 0.4618 | 62.22% | 75.97% |
| LSTM | 0.2142 | 0.1914 | 0.3800 | 56.00% | 75.00% |

**性能指标说明：**
- **MSE (均方误差)**：越小越好，GitPulse 相比纯 Transformer 降低了 57.9%
- **MAE (平均绝对误差)**：越小越好，GitPulse 相比纯 Transformer 降低了 35.5%
- **R² (决定系数)**：越大越好，GitPulse 达到 0.7699，说明模型解释了 76.99% 的方差
- **DA (方向准确率)**：预测方向正确率，GitPulse 达到 73.00%
- **TA@0.2 (阈值准确率)**：在 0.2 阈值下的趋势准确率，GitPulse 达到 81.75%
...
| 架构 | 仅时序 R² | +文本 R² | 提升幅度 |
|------|-----------|----------|----------|
| Transformer → GitPulse | 0.4618 | 0.7699 | **+66.7%** |
| GRU → GRU+Text | 0.5354 | 0.6496 | **+21.3%** |
...
GitPulse 的 R² 得分（0.7699）显著高于其他模型，表明模型具有更强的解释能力。
