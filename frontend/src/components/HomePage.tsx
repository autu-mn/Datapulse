      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <motion.div
              className="bg-cyber-card/30 backdrop-blur-sm rounded-xl border border-cyber-border p-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="bg-cyber-card/50 backdrop-blur-sm rounded-2xl border border-cyber-border p-6 shadow-2xl">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <label className="block text-sm font-medium text-cyber-muted mb-2 font-chinese">
                  仓库所有者
                </label>
