...
- [🔮 OpenVista](#-openvista)
    - [基于多模态时序预测的 GitHub 仓库生态画像分析平台](#基于多模态时序预测的-github-仓库生态画像分析平台)
  - [🌟 项目概述](#-项目概述)
    - [💡 我们解决什么问题](#-我们解决什么问题)
      - [🔴 当前痛点](#-当前痛点)
      - [✅ 我们的解决方案](#-我们的解决方案)
  ...
  - [🚀 快速开始](#-快速开始)
    ...
    - [🎯 一键安装（推荐）](#-一键安装推荐)
    - [📖 手动安装（高级用户）](#-手动安装高级用户)
      - [1️⃣ 克隆与初始化](#1️⃣-克隆与初始化)
      - [2️⃣ 部署 MaxKB](#2️⃣-部署-maxkb)
      - [3️⃣ 环境配置](#3️⃣-环境配置)
      - [4️⃣ 安装依赖](#4️⃣-安装依赖)
    - [🚀 启动服务](#-启动服务)
    - [🌐 访问平台](#-访问平台)
  ...
  - [🤖 MaxKB 智能问答系统](#-maxkb-智能问答系统)
    ...
    - [如何获取 MaxKB API 配置值](#如何获取-maxkb-api-配置值)
      ...
      - [2. MAXKB\_AI\_URL（API 基础地址）](#2-maxkb_ai_urlapi-基础地址)
      - [3. MAXKB\_API\_KEY（API 密钥）](#3-maxkb_api_keyapi-密钥)
    - [使用方式](#使用方式)
  ...
  - [✨ 功能亮点](#-功能亮点)
    ...
    - [评分算法](#评分算法)
      ...
      - [4. 维度得分计算](#4-维度得分计算)
      - [5. 月度评分](#5-月度评分)
      - [6. 异常值处理与最终评分](#6-异常值处理与最终评分)
      - [7. 总体评分](#7-总体评分)
  - [🤝 贡献指南](#-贡献指南)
  - [📄 许可证](#-许可证)
  - [📢 社区倡议](#-社区倡议)
  - [🙏 致谢](#-致谢)
    - [⭐ 如果这个项目对你有帮助，请给个 Star！⭐](#-如果这个项目对你有帮助请给个-star)
## 🛠️ 技术架构
